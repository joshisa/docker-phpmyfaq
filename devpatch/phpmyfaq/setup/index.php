            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <legend>Database setup</legend>
                    ...
                    <div id="dbdatafull">
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label" for="sql_port">Port:</label>
                            <div class="col-sm-8">
                                <input type="text" name="sql_port" id="sql_port" class="form-control"
                                    placeholder="5432">
                                <p class="help-block">Please enter the port to your database server.</p>
                            </div>
                        </div>
                        <div class="form-group">
